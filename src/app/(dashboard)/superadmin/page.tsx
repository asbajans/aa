  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-zinc-600">Tüm kullanıcılar, sınıflar, paket/kredi, hakediş, AI moderasyon — tek yerden.</p>
      </div>
      <div className="grid md:grid-cols-4 gap-4">
        ...
        <Card className="border-amber-200 bg-amber-50/50"><CardHeader><CardTitle>AI Klon Onayları</CardTitle><CardDescription>Ses izni + içerik denetimi</CardDescription></CardHeader><CardContent><Badge>Onay bekleyen: 0</Badge></CardContent></Card>
      </div>
      <Card>
