export default function KVKKPage() {
  return (
    <div className="mx-auto max-w-3xl px-4 py-12 prose prose-zinc prose-invert bg-[#030712] min-h-screen">
      ...
      <h2>2. Ses Klonlama (Akademi Klonu) Açık Rıza Metni</h2>
      <p>“Sesimin, yalnızca kendi Akademi Klonumun oluşturulması ve öğrencilerle etkileşimi için işlenmesine, saklanmasına ve ses teknolojisi sağlayıcısına aktarılmasına açık rıza veriyorum. Dilediğim an Klonumu durdurabilir, ses verimin silinmesini talep edebilirim. Klonum SuperAdmin onayı olmadan yayına alınmaz.”</p>
      <h2>3. Haklar</h2>
